...
; EXPECT: 87
;
; Investigation test: No inline initialization, both function calls
; Result: PASS (87 = 33 + 54)
;
; This test proves that calling both write_first and write_second works
; correctly when there is no inline struct initialization.
...
define i16 @test_main() {
  ...
  ; NO inline initialization - just call both functions
